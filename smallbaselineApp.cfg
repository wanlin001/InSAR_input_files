...
mintpy.load.compression     = gzip  #[gzip / lzf / no], auto for no.
##---------for ISCE only:
...
mintpy.load.intFile         = ../interferograms/*/filt_*.int  #[path pattern of wrapped interferogram   files], optional
...
mintpy.multilook.method     = nearest    #[nearest, mean, median], auto for nearest - lines/rows skipping approach
mintpy.multilook.ystep      = 3    #[int >= 1], auto for 1 - no multilooking
mintpy.multilook.xstep      = 3    #[int >= 1], auto for 1 - no multilooking
...
mintpy.network.minAreaRatio    = 0.4  #[0.0-1.0], auto for 0.75
...
mintpy.networkInversion.maskDataset   = coherence #[coherence / connectComponent / rangeOffsetStd / azimuthOffsetStd / no], auto for no
...
mintpy.troposphericDelay.weatherDir   = /home/wanlin001/InSAR/Weather  #[path2directory], auto for WEATHER_DIR or "./"
...
mintpy.troposphericDelay.gacosDir = /SAR_16804/weather_GACOS/PATH_105/tif # [path2directory], auto for "./GACOS"
...
mintpy.topographicResidual.stepFuncDate      = no  #[20080529,20190704T1733 / no], auto for no, date of step jump
...
mintpy.timeFunc.startDate   = 20170101   #[20070101 / no], auto for no
mintpy.timeFunc.endDate     = 20231111   #[20101230 / no], auto for no
mintpy.timeFunc.excludeDate = no   #[exclude_date.txt / 20080520,20090817 / no], auto for exclude_date.txt
...
mintpy.timeFunc.uncertaintyQuantification = bootstrap   #[residue, covariance, bootstrap], auto for residue
mintpy.timeFunc.timeSeriesCovFile         = timeSeriesCovFile.txt   #[filename / no], auto for no, time series covariance file
